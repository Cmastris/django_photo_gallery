...
3) Rename the [.env.example file](photo_gallery/photo_gallery/.env.example) to `.env` and assign a secret key string to the `DJANGO_SECRET_KEY` variable, as detailed in [Django's documentation](https://docs.djangoproject.com/en/5.2/ref/settings/#secret-key).
