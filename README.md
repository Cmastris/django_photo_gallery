...
5) Create a copy of [email_settings_example.py](photo_gallery/photo_gallery/email_settings_example.py) and rename it to `email_settings.py`. Adjust the settings as required (depending on the environment and deployment configuration, if applicable).
