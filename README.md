...
3) Rename the [secrets_template.py file](photo_gallery/photo_gallery/secrets_template.py) to `secrets.py` and assign a secret key string to the `KEY` variable, as detailed in [Django's documentation](https://docs.djangoproject.com/en/4.0/ref/settings/#std-setting-SECRET_KEY).
